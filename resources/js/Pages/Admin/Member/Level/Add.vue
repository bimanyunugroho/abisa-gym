...
const form = useForm({
    'name': '',
    'description': '',
    'can_train_without_trainer': false,
    'needs_orientation': false,
    'has_trainer_access': false,
    'max_guests': 0,
    'guest_fee': 0,
});
...
function handleSubmit() {
    ...
    router.post(route('admin.member-levels.store'), form, {
        preserveScroll: true,
        preserveState: true,
        onSuccess: () => {
            toast.success('Level anggota berhasil ditambahkan!');
            form.reset();
