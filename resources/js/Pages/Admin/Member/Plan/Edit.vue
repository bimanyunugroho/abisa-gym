...
const { props } = usePage();
const { title, desc, membershipPlan, memberLevels, durationTypes, errors: pageErrors } = props;
...
const form = useForm({
    ...
    'member_level_id': membershipPlan.member_level_id,
    'description': membershipPlan.description,
    'price': membershipPlan.price,
    'duration_days': membershipPlan.duration_days,
    'duration_type': membershipPlan.duration_type,
    'visit_limit': membershipPlan.visit_limit,
    'access_all_branches': membershipPlan.access_all_branches,
    'available_times': membershipPlan.available_times || [{
        start: '',
        end: ''
    }],
...
function handleSubmit() {
    ...
    router.put(route('admin.membership-plans.update', membershipPlan.slug), form, {
        preserveScroll: true,
        preserveState: true,
        onSuccess: () => {
            toast.success('Data plan berhasil diperbarui!');
