...
const { props } = usePage();
const { title, desc, users, memberRegistrations, visitTypes, guests, gymVisit, errors: pageErrors } = props;
const toast = useToast();

const form = useForm({
    user_id: gymVisit.user_id,
    member_registration_id: gymVisit.member_registration_id,
    guest_of: gymVisit.guest_of,
    check_in_time: gymVisit.check_in_time,
    check_out_time: gymVisit.check_out_time,
    visit_type: gymVisit.visit_type,
    paid_amount: gymVisit.paid_amount,
    notes: gymVisit.notes,
});
...
function handleSubmit() {
    ...
    router.put(route('admin.gym-visits.update', gymVisit.slug), form, {
        preserveScroll: true,
        preserveState: true,
        onSuccess: () => {
